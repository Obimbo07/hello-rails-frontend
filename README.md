...
**[Hello-react-frontend]** This project is used to display Random greetings from rails api server, the state and api disptch is done using redux. Here is the link to the rails backend application. [Backend Application](https://github.com/Obimbo07/hello-rails-backend).
